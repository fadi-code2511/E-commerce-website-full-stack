...
// password hash
userSchema.pre("save", async function () {      // before any save do this:
  if (!this.isModified("password")) return ;  // if this password for current user didn't modified return next()
