...
const CartDrawer = ({toggleCartDrawer,drawOpen}) => {
  ...
  return (
    <div className={`w-3/4 sm:w-1/2 md:w-[30rem] bg-red-100 fixed h-full top-0 right-0 flex  flex-col transition delay-100 ${drawOpen? "taranlate-x-0" : "translate-x-full"}  `}>
        ...
        <div className='flex  flex-col sticky  bottom-0 p-4  bg-yellow-50 justify-center items-center border-t-2 '>
