...
const GenderCollectionSection = () => {
  return (
    <section>
    <div className='flex container mx-auto  md:flex-row flex-col gap-8'>
        <div className='relative m-5 bg-gray-100 p-5 flex-1'>
            <img src={manCollectionImg} alt="" className='w-full object-cover h-[700px]'/>
        ...
        <div className='relative m-5 bg-gray-100 p-5 flex-1'>
            <img src={womanCollectionImg} alt="" className='w-full object-cover h-[700px]'/>
