  ...
  return (
    <div className='flex justify-center items-center'>
        <div className='w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12'>
            <form action="" className='w-full max-w-md  p-8 rounded-lg border shadow-sm'>
                <div className='flex flex-col p-5 '>
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <input value={email} onChange={(e)=>{setEmail(e.target.value)}}  type="Email" required name='username'placeholder='Enter you email address' className=' text-gray-700 p-1 placeholder:text-sm border rounded outline-blue-400 mb-2 ' />
                    </div>
                    <div className='flex flex-col gap-1'>
                    ...
                    <p className=' text-center text-sm tracking-tighter'>Dont have an account? <Link to="/register" className='text-sm text-blue-400 font-bold underline '>Register now</Link></p>
                </div>
            </form>
        </div>
